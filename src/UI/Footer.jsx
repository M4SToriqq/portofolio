...
const Footer = () => {
  const socials = [
    ...
    { icon: "ri-instagram-fill", href: "https://www.instagram.com/rixxieysc_/", label: "Instagram" },
  ...
  return (
    <footer className="mt-32 relative z-10">
      <div style={{ height: "1px", width: "100%", background: "linear-gradient(to right, transparent, rgba(139,92,246,0.3), transparent)", marginBottom: "3rem" }} />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-10">
            ...
            <div style={{ display: "flex", gap: "8px" }}>
              {socials.map(({ icon, href, label }) => (
                <a
                  ...
                  style={{ width: "36px", height: "36px", borderRadius: "10px", display: "flex", alignItems: "center", justifyContent: "center", color: "#9ca3af", textDecoration: "none", background: "rgba(139,92,246,0.05)", border: "1px solid rgba(139,92,246,0.12)", transition: "all 0.2s ease" }}
                  onMouseEnter={(e) => { e.currentTarget.style.color = "#7c3aed"; e.currentTarget.style.borderColor = "rgba(139,92,246,0.35)"; e.currentTarget.style.background = "rgba(139,92,246,0.1)"; e.currentTarget.style.transform = "translateY(-2px)"; }}
                  onMouseLeave={(e) => { e.currentTarget.style.color = "#9ca3af"; e.currentTarget.style.borderColor = "rgba(139,92,246,0.12)"; e.currentTarget.style.background = "rgba(139,92,246,0.05)"; e.currentTarget.style.transform = "translateY(0)"; }}
                >
        ...
        <div style={{ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "8px", paddingTop: "24px", borderTop: "1px solid rgba(139,92,246,0.1)" }}>
