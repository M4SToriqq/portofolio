...
const Navbar = ({ hidden = false }) => {
  ...
  return (
    <nav
      className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 sm:px-10 lg:px-16 xl:px-24 transition-all duration-500"
      style={{
        height: scrolled ? "60px" : "80px",
        background: scrolled ? "rgba(240,253,250,0.88)" : "transparent",
        backdropFilter: scrolled ? "blur(20px)" : "none",
        borderBottom: scrolled ? "1px solid rgba(13,148,136,0.15)" : "1px solid transparent",
        boxShadow: scrolled ? "0 4px 24px rgba(13,148,136,0.08)" : "none",
      }}
    >
        ...
        {links.map(({ href, label, id }) => (
          <li key={id}>
            <a
              ...
              style={{ color: activeSection === id ? "#0d9488" : "#6b7280" }}
            >
              {activeSection === id && (
                <span
      ...
      <a
        ...
        onMouseEnter={(e) => { e.currentTarget.style.background = "rgba(13,148,136,0.18)"; e.currentTarget.style.boxShadow = "0 4px 20px rgba(13,148,136,0.2)"; }}
        onMouseLeave={(e) => { e.currentTarget.style.background = "rgba(13,148,136,0.1)"; e.currentTarget.style.boxShadow = "none"; }}
      >
          ...
          <a key={id} href={`#${id}`}>
            <span
              ...
              style={{
                ...
                height: "6px",
                background: activeSection === id ? "#0d9488" : "#d1d5db",
              }}
            />
          </a>
        ))}
